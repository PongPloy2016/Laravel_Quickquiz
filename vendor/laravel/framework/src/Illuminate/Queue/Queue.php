...
abstract class Queue
{
    ...
    $encrypter = $this->container->bound(Encrypter::class) ? $this->container[Encrypter::class] : null;

        $command = $this->jobShouldBeEncrypted($job) && $encrypter
            ? $encrypter->encrypt(serialize(clone $job))
            : serialize(clone $job);

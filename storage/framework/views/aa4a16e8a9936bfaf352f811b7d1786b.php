      ...
      <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-4">
          <div class="quiz-card">
            ...
            <a href="<?php echo e(route('all_reports.show', $topic->id)); ?>" class="btn btn-wave">Show Report</a>
          </div>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', [
  ...
  'all_re' => 'active',
  'sett' => ''
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/quickquiz/resources/views/admin/all_reports/index.blade.php ENDPATH**/ ?>